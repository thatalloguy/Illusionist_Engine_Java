...
public class Gizmo{
	...
	public Gizmo(ECS ecs, Loader loader, Mouse mouse, KeyBoard keyboard) {
		...
		tx.name = "TX";ty.name = "TZ";tz.name = "TZ";
		...
		sx.name = "TX";sy.name = "TZ";sz.name = "TZ";
		...
		rx.name = "TX";ry.name = "TZ";rz.name = "TZ";
		...
		if (selE == null) {
			...
			if (this.mode == "TRANSLATION") {
				...
				if (tx.isSelected && ty.isSelected == false && tz.isSelected == false ) {
					ty.isSelected = false;
					tz.isSelected = false;
					selE.setPosition(new Vector3f(selE.getPosition().x += mouse.getRelMouse().x * 0.1f, selE.getPosition().y, selE.getPosition().z));
					mouse.resetRel();	
				}
				...
				if (ty.isSelected && tx.isSelected == false && tz.isSelected == false ) {
					tx.isSelected = false;
					tz.isSelected = false;
					selE.setPosition(new Vector3f(selE.getPosition().x, selE.getPosition().y -= mouse.getRelMouse().y * 0.1f, selE.getPosition().z));
					mouse.resetRel();
				}
				if (tz.isSelected && tx.isSelected == false && ty.isSelected == false ) {
					ty.isSelected = false;
					tx.isSelected = false;
					selE.setPosition(new Vector3f(selE.getPosition().x, selE.getPosition().y, selE.getPosition().z += mouse.getRelMouse().x * 0.1f));
					mouse.resetRel();
				}
			}
